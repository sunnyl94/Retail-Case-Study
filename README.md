...
- 통계적 분석: 상품 전환율 (CVR), 카테고리별 기하평균 (CAGR), Z 차트, ABC 매출 등급, 구매주기 경과 고객 (CRM)
- 추가 분석: **퍼널, 코호트, RFM 분석**

### 📝 결론
각 카테고리별 매출 성장률을 분석하고 마케팅을 차별화하여 수익을 극대화 시킬 수 있는 방법을 분석해보았다\
<br />
차별화된 마케팅 전략으로 우수 고객수를 유지 시키고 점수가 낮은 고객은 충성 고객으로 전환시킨다.
